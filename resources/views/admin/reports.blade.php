            ...
            <div id="accordion">
                <div class="card">
                    ...
                    <div id="collapseCategories" class="collapse show" aria-labelledby="headingCategories" data-parent="#accordion">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.report.generate', ['table' => 'categories']) }}">
                ...
                <div class="card">
                    ...
                    <div id="collapseForums" class="collapse" aria-labelledby="headingForums" data-parent="#accordion">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.report.generate', ['table' => 'forums']) }}">
                                @php ($columns = $forums)
                                @include('admin.includes.report-form')
                            </form>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseTopics" class="collapse" aria-labelledby="headingTopics" data-parent="#accordion">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.report.generate', ['table' => 'topics']) }}">
                                @php ($columns = $topics)
                                @include('admin.includes.report-form')
                            </form>
                        </div>
                ...
                <div class="card">
                    ...
                    <div id="collapseUsers" class="collapse" aria-labelledby="headingUsers" data-parent="#accordion">
                        <div class="card-body">
                            <form method="post" action="{{ route('admin.report.generate', ['table' => 'users']) }}">
                                @php ($columns = $users)
                                @include('admin.includes.report-form')
                            </form>
                        </div>
