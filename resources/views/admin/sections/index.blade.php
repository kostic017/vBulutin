            ...
            @foreach ($categories as $_category)
                <div class="sortable-category">
                    ...
                    <div class="category-header">
                        ...
                        <div class="actions">
                            <a href="{{ route('categories.show.admin', [$current_board->address, $_category->slug]) }}" class="btn" title="Pregledaj kategoriju"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('forums.create', [$current_board->address, 'category', $_category->id]) }}" class="btn" title="Novi forum"><i class="fas fa-file"></i></a>
                            <a href="{{ route('categories.edit', [$current_board->address, $_category->slug]) }}" class="btn" title="Izmeni kategoriju"><i class="fas fa-pencil-alt"></i></a>
                            ...
                            <ol class="dd-list">
                                @foreach ($_category["parent_forums"] as $_parent_forum)
                                   <li class="dd-item" data-id="{{ $_parent_forum->id }}">
                                        ...
                                        <div class="actions">
                                            <a href="{{ route('forums.show.admin', [$current_board->address, $_parent_forum->slug]) }}" class="btn" title="Pregledaj forum"><i class="fas fa-eye"></i></a>
                                            <a href="{{ route('forums.create', [$current_board->address, 'parent_forum', $_parent_forum->id]) }}" class="btn" title="Novi potforum"><i class="fas fa-file"></i></a>
                                            <a href="{{ route('forums.edit', [$current_board->address, $_parent_forum->slug]) }}" class="btn" title="Izmeni forum"><i class="fas fa-pencil-alt"></i></a>
